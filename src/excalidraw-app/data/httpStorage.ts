...
const HTTP_STORAGE_BACKEND_URL = document.location.host.startsWith("localhost")
  ? "http://localhost:3003/api/v2"
  : "https://vi-excalidraw-collab.libicraft.ru/api/v2"; // process.env.REACT_APP_HTTP_STORAGE_BACKEND_URL;
const SCENE_VERSION_LENGTH_BYTES = 4;

console.info(
  "[Excalidraw/app] Use backend storage host:",
